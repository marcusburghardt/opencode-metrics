# Subagent Linking Specification

## Purpose

Track parent-child relationships between sessions to enable recursive
cost aggregation and deterministic sub-agent detection without
denormalized columns or classification rules.
